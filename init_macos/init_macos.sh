...
brew install --cask font-iosevka-aile font-iosevka-ss04
...
brew install coreutils ripgrep fd gls pandoc tree shellcheck fontconfig
...
pip install isort pipenv nose flake8 black mypy
